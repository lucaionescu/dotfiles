...
if ! ask "This installer will only work properly if you are a member of ${bf}LMU Munich${n} and the user group: ${bf}eduroam campus.lmu.de / lmu.de.${n}" "Continue" 1 ; then exit; fi
